...
public class ChatClient2 extends JFrame implements ActionListener {
    ...
    public ChatClient2(DatagramSocket s,String m,String y) {
    	MyName = m;
    	YourName = y;
    ...
    public void actionPerformed(ActionEvent e) {
    	try {
			InetAddress adr = InetAddress.getByName("192.168.44.61");
...
//					clientSocket.close();
    ...
    public static void main(String[] args)  {
        ...
        ChatClient2 client = new ChatClient2(socket,"JJ","Fan");
